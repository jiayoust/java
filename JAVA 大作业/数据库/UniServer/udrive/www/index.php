...
<?php 
  ...
  <div id="content">
    ...
    <p>Welcome to the Uniform Server defualt start page. This page and every other file are being served from the main server root folder, "/www/". <br /> Additional support can be found on the <a target="_1" href="http://wiki.uniformserver.com/index.php/Category:Uniform_Server_4.0-Mona">Wiki</a>.</p>
    <p>&nbsp;</p>
