...
# MPG 28-2-2009 - Reverted header('Location:...
####################################################
*/
...
<p class="copyright"><span class="name"><?php echo  $US['apanel']?> <?php echo $version?></span> 
| © 2007 <?php echo  $US['dev-team']?> | <a href="http://www.eksperten.dk/artikler/218"><?php echo  $US['vhost-credit']?></a> <?php include "includes/code.php"; ?></div>
</body>
</html>
