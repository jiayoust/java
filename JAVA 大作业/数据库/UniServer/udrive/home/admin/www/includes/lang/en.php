...
$US = array(
	...
	'cert-head' => 'Server Certificate and Key Generation',
	'cert-verify1' => 'Verify Generation',
	'cert-verify2' => 'Click on Generate! and follow instructions.',
	'cert-verify3' => 'Generate!',
	
	//--------------------------------------------------------------------------------------------
	// Server Key & Cert Gen
	//--------------------------------------------------------------------------------------------
	
	'mysql-head' => 'MySQL restore password',
	'mysql-verify1' => 'Verify Generation',
	'mysql-verify2' => 'Click on Restore! and follow instructions.',
	'mysql-verify3' => 'Restore!',
	...
	add more security to the server by blocking it using the Auth method, then change this in by editing the '.$server_path_ssl.'/.htaccess file.',
